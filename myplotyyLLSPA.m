function myplotyyLLSPA(MatrixPlot_x_left,MatrixPlot_y_left,Plot_x_right,Plot_y_right,CellType,XLabels_in, Transp)
...
if length(h1)>5
    legend('Ceiling', 'Acoustic', 'AcSem', 'Semantic','Null-Model','Saturated', 'Location','SouthEast')
    ylabel(ax(1),sprintf('Average LogLikelihood %s',CellType))
else
    legend('Ceiling', 'Acoustic', 'AcSem', 'Semantic','Null-Model', 'Location','SouthEast')
